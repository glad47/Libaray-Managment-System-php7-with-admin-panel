...
if(!empty($_REQUEST['insert'])){
    ...
    $date=$_REQUEST['date'];
    $info=$_REQUEST['info'];
    $q="insert into feedback(date,info) values ('$date','$info')";
    mysqli_query($conn,$q);
    $feedback_id=mysqli_insert_id($conn);
    $q="insert into cus_feed(cus_id,feed_id) values ('$id','$feedback_id')";
mysqli_query($conn,$q);
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="feedback_insert.php">
                    <h4>Feedback Insert New Record</h4>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="info" placeholder="info"  required>
                        </div>
...
<script type="text/javascript">
    function searchq(){
        ...
        $.post("search_feedback_insert.php",{searchVal:searchTxt},function(data){
                $("#output").html(data);
            }
        );
    }

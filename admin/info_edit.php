...
if(!empty($_REQUEST['update'])){
    ...
    $tell=$_REQUEST['tell'];
    $q="update info set address='$address',email='$email',tell='$tell' where id='$id'";
    mysqli_query($conn,$q);
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="info_edit.php">
                    <h4>Info Updating</h4>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>tell</label>
                            <input  class="form-control" name="tell" value="<?php echo $row['tell'];?>"  required>
                        </div>

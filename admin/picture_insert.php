    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="picture_insert.php">
                    <h4>Picture Insert New Record</h4>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>name</label>
                            <input class="form-control" name="name" placeholder="enter the picture name or link " required> //dont do any thing if name already existed
                        </div>

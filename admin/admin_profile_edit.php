...
if(!empty($_REQUEST['update'])){
    ...
    if(strlen($username)<5){
        ...
        $password=md5($password);
            ...
            $message="<a href='http://localhost/hotel/admin/registeration_verified.php?vkey=$vkey'>Update information</a>";
            $headers="From:zizoo4949@yahoo.com"."\r\n";
            $headers.="MIME-Version: 1.0"."\r\n";
            $headers.="Content-Type: text/html; charset=UTF-8"."\r\n";
           if( mail($to,$subject,$message,$headers)) {
               $q = "update admin set username='$username',password='$password',email='$email',vkey='$vkey',verified='0' where id='$id'";
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="admin_profile_edit.php">
                    <h4>Accout Updating</h4>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password2" value="<?php echo $row['password'];?>"  required>
                        </div>
                    </div>

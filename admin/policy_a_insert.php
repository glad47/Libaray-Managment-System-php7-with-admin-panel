...
if(!empty($_REQUEST['insert'])){
    ...
    $q="insert into policy_analytics (intro,content) values ('$intro','$content')";
    mysqli_query($conn,$q);
    header("location:policy_a.php");
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="policy_a_insert.php">
                    <h4>Policy_analytics Insert New Record</h4>

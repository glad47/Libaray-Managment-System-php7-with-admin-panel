                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="customer_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-circle" title="Edit">Edit</a>
                                    <a href="customer_del.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure to proceed?')" class="btn btn-danger btn-circle" title="Delete">Delete</a>
                                </td>
                            </tr>
                            </tbody>
                            <?php } ?>
                        ...
                        <!-- /.table-responsive -->
                        <div class="panel-body">
                            <a href="customer_insert.php" type="button" class="btn btn-primary">Add New</a>

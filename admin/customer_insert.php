...
if(!empty($_REQUEST['insert'])){
    ...
    if($count == 1){
        ...
        $q="insert into customer(name,age,gender,email,phone_no,acc_no,username,password,more,vkey,verified) values ('$name','$age','$gender','$email','$phone_no','$acc_no',
'$username','$password','$more','$vkey','1')";
        mysqli_query($conn,$q);
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="customer_insert.php">

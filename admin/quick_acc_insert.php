...
if(!empty($_REQUEST['insert'])){
    $name=$_REQUEST['name'];
    $link=$_REQUEST['link'];
    $q="insert into quick_acc(name,link) values ('$name','$link')";
    mysqli_query($conn,$q);
    header("location:quick_acc.php");
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="quick_acc_insert.php">
                    <h4>Quick_access Insert New Record</h4>

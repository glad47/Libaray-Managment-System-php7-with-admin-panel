...
if(!empty($_REQUEST['update'])){
    ...
    $q="update faq set ques='$ques',answ='$answ' where id='$id'";
    mysqli_query($conn,$q);
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="faq_edit.php">
                    <h4>FAQ Updating</h4>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>answer</label>
                            <input class="form-control" name="answ" value="<?php echo $row['answ'];?>"  required>
                        </div>

...
if(!empty($_REQUEST['insert'])){
    ...
    $q="insert into header(ref,content) values ('$ref','$content')";
    mysqli_query($conn,$q);
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="header_insert.php">
                    <h4>Header Insert New Record</h4>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>reference</label>
                            <input class="form-control" name="ref" placeholder="reference" required>
                        </div>
                        <div class="form-group">
                            <label>content</label>

...
if(!empty($_REQUEST['insert'])){
    ...
    $tell=$_REQUEST['tell'];
    $q="insert into info (address,email,tell) values ('$address','$email','$tell')";
    mysqli_query($conn,$q);
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="info_insert.php">
                    <h4>Info Insert New Record</h4>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>tell</label>
                            <input  class="form-control" name="tell" placeholder="tell"  required>
                        </div>

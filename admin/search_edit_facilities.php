...
if(isset($_REQUEST['searchVal'])){
    $output='';
    $facilities_id=$_REQUEST['id'];
    $searchq=$_REQUEST['searchVal'];
    $searchq=preg_replace("#[^0-9a-z]#i","",$searchq);
    $q="select * from employee  where facilities_id='$facilities_id' and( id like '%$searchq%' or name
 like '%$searchq%' or email like '%$searchq%' or phone_no like '%$searchq%' or acc_no like
'%$searchq%' or username like '%$searchq%' or address like '%$searchq%' or salary like '%$searchq%' 
 or qualification like '%$searchq%' or

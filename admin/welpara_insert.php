...
if(!empty($_REQUEST['insert'])){
    ...
    $text=$_REQUEST['text'];
    $q="insert into welpara(intro,text) values ('$intro','$text')";
    mysqli_query($conn,$q);
    header("location:welpara.php");
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="welpara_insert.php">
                    <h4>welcome paragraph Insert New Record</h4>

...
if(!empty($_REQUEST['insert'])){
    ...
    echo $manager_id;
    $q="insert into facilities(name,location,manager_id) values ('$name','$location','$manager_id')";
    mysqli_query($conn,$q);
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" method="post" action="facilities_insert.php">
                    <h4>Facilities Insert New Record</h4>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="search" placeholder="search for the manager id...."
                                   onkeydown="searchq();">
...
<script type="text/javascript">
    function searchq(){
        ...
        $.post("search.php",{searchVal:searchTxt},function(data){
                $("#output").html(data);
            }
        );
    }

...
if(!empty($_REQUEST['login'])){
    ...
    $q="select * from customer where username='$username' and password='$password' and verified='1' LIMIT 1";
...
//header("locarion:login.php?error=1");
...
<head>
    ...
    <title>Login &#8211;Habibi Hotel</title>
                                ...
                                <div class="cmsmasters_row_margin">
                                    <div id="cmsmasters_column_11b707bf2a" class="cmsmasters_column one_first">
                                        <div class="cmsmasters_column_inner"><div id="cmsmasters_heading_c26a058b3e" class="cmsmasters_heading_wrap cmsmasters_heading_align_center">
                                                ...
                                                <h2 class="cmsmasters_heading">login</h2>
                                            </div>
                                        </div></div>
                                </div>
                            </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="#" method="post" id="form_704">
                                        ...
                                        <div class="form_info cmsmasters_input one_half">
                                            <label for="cmsmasters_name_2">Username <span class="color_2">*</span></label>
                                        ...
                                        <br>
                                        <input type="submit" name="login"  value="Login" size="35" >

                                    </form>
                                    <form action="signup.php" method="post" " >
<br>
                                        <input type="submit"   value="Sign up" size="35" >

...
<title>Rooms 2 Columns &#8211;Habibi Hotel</title>
...
<style id='hotel-lux-style-inline-css' type='text/css'>
    ...
    .headline_outer {
        background-image:url(https://hotel-lux.cmsmasters.net/wp-content/uploads/2015/12/3.jpg);
...
<style id='hotel-lux-retina-inline-css' type='text/css'>
    #cmsmasters_row_eadd33da89 {
        background-color:#f9f9f9;
    }

    #cmsmasters_row_eadd33da89 .cmsmasters_row_outer_parent {
        padding-top: 130px;
    }
    ...
    #cmsmasters_heading_c16df6efd0 {
        text-align:center;
        margin-top:0px;
        margin-bottom:0px;
    }

    #cmsmasters_heading_c16df6efd0 .cmsmasters_heading {
        text-align:center;
    }

    #cmsmasters_heading_c16df6efd0 .cmsmasters_heading, #cmsmasters_heading_c16df6efd0 .cmsmasters_heading a {
    ...
    #cmsmasters_heading_c16df6efd0 .cmsmasters_heading a:hover {
    }

    #cmsmasters_heading_c16df6efd0 .cmsmasters_heading_divider {
    }
    ...
    #cmsmasters_heading_31ac8fc691 {
        text-align:center;
        margin-top:-72px;
        margin-bottom:110px;
    }

    #cmsmasters_heading_31ac8fc691 .cmsmasters_heading {
        text-align:center;
    }

    #cmsmasters_heading_31ac8fc691 .cmsmasters_heading, #cmsmasters_heading_31ac8fc691 .cmsmasters_heading a {
        font-size:60px;
        line-height:60px;
    }

    #cmsmasters_heading_31ac8fc691 .cmsmasters_heading a:hover {
    }

    #cmsmasters_heading_31ac8fc691 .cmsmasters_heading_divider {
    }
...
<link rel="canonical" href="https://hotel-lux.cmsmasters.net/rooms-2-columns/" />
<link rel='shortlink' href='https://hotel-lux.cmsmasters.net/?p=8946' />
<link rel="alternate" type="application/json+oembed" href="https://hotel-lux.cmsmasters.net/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fhotel-lux.cmsmasters.net%2Frooms-2-columns%2F" />
<link rel="alternate" type="text/xml+oembed" href="https://hotel-lux.cmsmasters.net/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fhotel-lux.cmsmasters.net%2Frooms-2-columns%2F&#038;format=xml" />
...
<body data-rsssl=1 class="page-template-default page page-id-8946 woocommerce-no-js tribe-no-js">
...
<header id="header" class="header_fullwidth">
    <div class="header_mid" data-height="70">
        <div class="header_mid_outer"><div class="header_mid_inner"><div class="logo_wrap"><a href="index.php" title="Habibi" class="logo">
                ...
                <div class="mid_nav_wrap"><nav><div class="menu-primary-navigation-container"><ul id="navigation" class="mid_nav navigation">
                                ...
                                <?php while($row=mysqli_fetch_assoc($res)) { ?>
                                    <li id="menu-item-13035" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home
                                    current-menu-item page_item page-item-7366 current_page_item current-menu-ancestor current-menu-parent
                                    current_page_parent current_page_ancestor menu-item-has-children menu-item-13035 menu-item-depth-0">
                                        <a href="<?php echo $row['ref'];?>" >
                                           <span class="nav_item_wrap">
                                            <span class="nav_title"> <?php echo $row['content'];?></span>
                                            </span>
                                        </a>
                                    </li>
                                <?php } ?>
    ...
    <div class="headline cmsmasters_color_scheme_default">
        <div class="headline_outer">
            <div class="headline_color"></div><div class="headline_inner align_center">
                <div class="headline_aligner"></div><div class="headline_text"><h1 class="entry-title">Rooms</h1></div><div class="cmsmasters_breadcrumbs"><div class="cmsmasters_breadcrumbs_aligner"></div><div class="cmsmasters_breadcrumbs_inner"><a href="index.php" class="cms_home">Home</a>
                        <span class="breadcrumbs_sep"> / </span>
                        <span>Rooms</span></div></div></div></div>
    </div><div class="middle_inner">
        <div class="content_wrap fullwidth">

            <!-- Start Content -->
            <div class="middle_content entry"></div></div><div id="cmsmasters_row_eadd33da89" class="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_boxed">
            <div class="cmsmasters_row_outer_parent">
                <div class="cmsmasters_row_outer">
                    <div class="cmsmasters_row_inner">
                        <div class="cmsmasters_row_margin">
                            <div id="cmsmasters_column_b69484d61c" class="cmsmasters_column one_first">
                                <div class="cmsmasters_column_inner"><div id="cmsmasters_heading_c16df6efd0" class="cmsmasters_heading_wrap cmsmasters_heading_align_center">
                                        <h3 class="cmsmasters_heading">Awesome</h3>
                                    </div><div id="cmsmasters_heading_31ac8fc691" class="cmsmasters_heading_wrap cmsmasters_heading_align_center">
                                        <h2 class="cmsmasters_heading">Luxury room</h2>
                                    </div><div id="portfolio_b391784ca5" class="cmsmasters_wrap_portfolio entry-summary" data-layout="grid" data-layout-mode="perfect" data-url="https://hotel-lux.cmsmasters.net/wp-content/plugins/cmsmasters-content-composer/" data-orderby="date" data-order="ASC" data-count="8" data-categories="bathroom,cable-tv,conditioning,hair-dryer,mini-bar,queen,room-services" data-metadata="title,price"><div class="portfolio grid large_gap perfect cmsmasters_2"><!-- Start Project Grid Article -->

                                            <?php $res=getLux(); ?>

                                            <?php while( $row=mysqli_fetch_assoc($res) ) {
                                                $res2=getLuxPic1($row['id']);
                                                $row2=mysqli_fetch_assoc($res2);
                                                ?>

                                            <!-- Start Project Grid Article -->
                                            <article id="post-13193" class="cmsmasters_project_grid post-13193 project type-project status-publish format-standard
                                            has-post-thumbnail hentry pj-categs-bathroom pj-categs-cable-tv pj-
                                            categs-conditioning pj-categs-hair-dryer pj-categs-mini-bar pj-categs-
                                            room-services" data-category="bathroom cable-tv conditioning hair-dryer mini-bar room-services">
                                                <div class="project_outer">
                                                    <div class="project_img_wrap">
                                                        <figure class="cmsmasters_img_rollover_wrap preloader">
                                                            <img width="580" height="420" src="<?php echo $row2['name'];?>"
                                                                 class="full-width wp-post-image" alt="<?php echo $row['title'];?>"
                                                                 title="<?php echo $row['title'];?>"
                                                                 />
                                                            <a href=<?php echo $row['link'];?>
                                                               title=<?php echo $row['title'];?> class="cmsmasters_open_link"></a>
                                                        </figure>
                                                    </div>
                                                    <header class="cmsmasters_project_header entry-header">
                                                        ...
                                                        </h3></header><div class="cmsmasters_project_cont_info_wrapper">
                                                        <span class="cmsmasters_project_price"><?php echo $row['price'];?>t</span>
                                                    </div><span class="dn meta-date">20170510143118</span>	</div>
                                            </article>
...
<script type='text/javascript' src='https://hotel-lux.cmsmasters.net/wp-content/themes/hotel-lux/js/jquery.isotope.min.js?ver=1.5.19'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
    var cmsmasters_isotope_mode = {"theme_url":"https:\/\/hotel-lux.cmsmasters.net\/wp-content\/themes\/hotel-lux","site_url":"https:\/\/hotel-lux.cmsmasters.net\/","ajaxurl":"https:\/\/hotel-lux.cmsmasters.net\/wp-admin\/admin-ajax.php","nonce_ajax_like":"685c16a903","nonce_ajax_view":"495c336d2a","project_puzzle_proportion":"1.55","gmap_api_key":"AIzaSyBIyWpcN4BzUQduapNmX5kb2DruMvy2KMc","gmap_api_key_notice":"Please add your Google Maps API key","gmap_api_key_notice_link":"read more how","primary_color":"#b99470","ilightbox_skin":"dark","ilightbox_path":"vertical","ilightbox_infinite":"0","ilightbox_aspect_ratio":"1","ilightbox_mobile_optimizer":"1","ilightbox_max_scale":"1","ilightbox_min_scale":"0.2","ilightbox_inner_toolbar":"0","ilightbox_smart_recognition":"0","ilightbox_fullscreen_one_slide":"0","ilightbox_fullscreen_viewport":"center","ilightbox_controls_toolbar":"1","ilightbox_controls_arrows":"0","ilightbox_controls_fullscreen":"1","ilightbox_controls_thumbnail":"1","ilightbox_controls_keyboard":"1","ilightbox_controls_mousewheel":"1","ilightbox_controls_swipe":"1","ilightbox_controls_slideshow":"0","ilightbox_close_text":"Close","ilightbox_enter_fullscreen_text":"Enter Fullscreen (Shift+Enter)","ilightbox_exit_fullscreen_text":"Exit Fullscreen (Shift+Enter)","ilightbox_slideshow_text":"Slideshow","ilightbox_next_text":"Next","ilightbox_previous_text":"Previous","ilightbox_load_image_error":"An error occurred when trying to load photo.","ilightbox_load_contents_error":"An error occurred when trying to load contents.","ilightbox_missing_plugin_error":"The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin<\\\/a>."};
    /* ]]> */
</script>
<script type='text/javascript' src='https://hotel-lux.cmsmasters.net/wp-content/themes/hotel-lux/theme-framework/theme-style/js/jquery.isotope.mode.js?ver=1.0.0'></script>

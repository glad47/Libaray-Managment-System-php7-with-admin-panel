...
if(!empty($_REQUEST['submit'])){
    ...
    if($count == 0){
        ...
        $q="select * from customer where username='$username' LIMIT 1";
...
<title>Reservation &#8211;Habibi Hotel</title>
...
<div class="headline cmsmasters_color_scheme_default">
    <div class="headline_outer">
        <div class="headline_color"></div><div class="headline_inner align_center">
            <div class="headline_aligner"></div><div class="headline_text"><h1 class="entry-title">Reservation</h1></div><div class="cmsmasters_breadcrumbs"><div class="cmsmasters_breadcrumbs_aligner"></div><div class="cmsmasters_breadcrumbs_inner"><a href="index.php" class="cms_home">Home</a>
                    <span class="breadcrumbs_sep"> / </span>
                    <span>Reservation</span></div></div></div></div>
                ...
                <div class="cmsmasters_row_margin">
                    <div id="cmsmasters_column_11b707bf2a" class="cmsmasters_column one_first">
                        <div class="cmsmasters_column_inner"><div id="cmsmasters_heading_c26a058b3e" class="cmsmasters_heading_wrap cmsmasters_heading_align_center">
                                ...
                                <h2 class="cmsmasters_heading">make a reservation</h2>
                            </div>
                        </div></div>
                </div>
            </div>
    ...
    <form role="form" method="post" action="">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input  class="form-control" name="institute" value=""  required>
            </div>
            <div class="form-group">
                <label>Description</label>
                <input class="form-control" name="text" value=""  required>
            </div>
        ...
        <div class="col-lg-12">
            <form role="form" method="post" action="">
                <div class="modal-body">
                    ...
                    <form action="reservation.php" method="post" id="form_704">


                        <div class="form_info cmsmasters_input one_half">
                            <label for="cmsmasters_subject">ADULTS <span class="color_2">*</span></label>

                            <div class="form_field_wrap">
                                <input type="radio" name="adults" class="" value="0" size="35" requried>---</input>
                                <input type="radio" name="adults" class="" value="1" size="35" requried>ONE</input>
                                <input type="radio" name="adults" class="" value="2" size="35" requried>TWO</input>
                                <input type="radio" name="adults" class="" value="3" size="35" requried>THREE</input>
                                <input type="radio" name="adults" class="" value="4" size="35" requried>FOUR</input>
                                <input type="radio" name="adults" class="" value="5" size="35" requried>FIVE</input>
                        ...
                        <div class="form_info cmsmasters_input one_half">
                            <label for="cmsmasters_subject">CHILDREN <span class="color_2">*</span></label>

                            <div class="form_field_wrap">
                                <input type="radio" name="children" class="" value="0" size="35" requried>---</input>
                                <input type="radio" name="children" class="" value="1" size="35" requried>ONE</input>
                                <input type="radio" name="children" class="" value="2" size="35" requried>TWO</input>
                                <input type="radio" name="children" class="" value="3" size="35" requried>THREE</input>
                                <input type="radio" name="children" class="" value="4" size="35" requried>FOUR</input>
                                <input type="radio" name="children" class="" value="5" size="35" requried>FIVE</input>
                        ...
                        <div class="form_info cmsmasters_input one_half">
                            <label for="cmsmasters_subject">CHECK IN DATE <span class="color_2">*</span></label>

                            <div class="form_field_wrap">
                                <input type="text" name="c_in" placeholder="YYYY-MM-DD"  pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" size="35" required>
                                <br><br><br>
                            </div>
                        </div>
                        <div class="">
                            <label for="cmsmasters_subject">CHECK OUT DATE <span class="color_2">*</span></label>

                            <div class="">
                                <input type="text" name="c_out" placeholder="YYYY-MM-DD"  pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" size="35" required>
                                <br><br><br>
                            </div>
                        </div>
                        <div class="form_info cmsmasters_input one_half">
                            <label for="cmsmasters_subject">ROOM SUITs <span class="color_2">*</span></label>

                            <div class="form_field_wrap">
                                <input type="radio" name="lux_id" class="" value="1" size="35" requried>LUXURY FAMILY DOUBLE ROOM</input>
                                <br>
                                <input type="radio" name="lux_id" class="" value="2" size="35" requried>Luxury Single ROOM</input>
                                <br>
                                <input type="radio" name="lux_id" class="" value="3" size="35" requried>PREMIUM DOUBLE ROOM</input>
                                <br>
                                <input type="radio" name="lux_id" class="" value="4" size="35" requried>PREMIUM SINGLE ROOM</input>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="form_field_wrap">
                                <input type="submit" name="submit"  value="MAKE RESERVATION" size="35" >
                                <br>
                            </div>
                        </div>
                    </form>
...
<script>
        ...
        <div id="cmsmasters_row_fcb76a0f78" class="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_boxed">
            <div class="cmsmasters_row_outer_parent">
                <div class="cmsmasters_row_outer">
                    <div class="cmsmasters_row_inner">
                        <div class="cmsmasters_row_margin">
                            <div id="cmsmasters_column_255e96aca6" class="cmsmasters_column one_fourth">
                                <div class="cmsmasters_column_inner"></div></div>
                            <div id="cmsmasters_column_af4a2be581" class="cmsmasters_column one_half">
                                <div class="cmsmasters_column_inner"><div id="cmsmasters_divider_e8727ea668" class="cmsmasters_divider cmsmasters_divider_width_long cmsmasters_divider_pos_center"></div>
                                </div></div>
                            <div id="cmsmasters_column_e7134d2a0e" class="cmsmasters_column one_fourth">
                                <div class="cmsmasters_column_inner"></div></div>
                        </div>
                    </div>
                </div>
        ...
        <div id="cmsmasters_row_883603364a" class="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_boxed">
            <div class="cmsmasters_row_outer_parent">
                <div class="cmsmasters_row_outer">
                    <div class="cmsmasters_row_inner">
                        <div class="cmsmasters_row_margin">
                            <div id="cmsmasters_column_5f40b47d89" class="cmsmasters_column one_first">
                                <div class="cmsmasters_column_inner"><div id="cmsmasters_heading_9b30430c56" class="cmsmasters_heading_wrap cmsmasters_heading_align_center">
        ...
        <div id="cmsmasters_row_752cf9cc3a" class="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default
        cmsmasters_row_bot_default cmsmasters_row_boxed">
            <div class="cmsmasters_row_outer_parent">
                <div class="cmsmasters_row_outer">
                    <div class="cmsmasters_row_inner">
                        <div class="cmsmasters_row_margin">
                            <div id="cmsmasters_column_aab1b17bd4" class="cmsmasters_column one_fourth">
                                <div class="cmsmasters_column_inner"></div></div>
                            <div id="cmsmasters_column_350a2f3065" class="cmsmasters_column one_half">

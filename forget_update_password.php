...
if(!empty($_REQUEST['submit'])) {
    if(!empty($_REQUEST['submit'])){
        ...
        if($password == $password2) {
            ...
            $q = "update customer set password='$password' where id='$id'";
            mysqli_query($conn, $q);
...
echo 'alert("the passwords does not match please try again ");';
echo 'window.location.href = "forget_update_password.php?id='."$id".'";';
echo '</script>';
...
<head>
    ...
    <title>Reset password &#8211;Habibi Hotel</title>
                ...
                <form role="form" method="post" action="forget_update_password.php">
                    <div class="modal-body">
                        ...
                        <div class="form_info cmsmasters_input one_half">
                            <label for="cmsmasters_name_2">reset password<span class="color_2">*</span></label>

                            <div class="form_field_wrap">
                                <input type="password" name="password"  placeholder="new password" size="35"
                                       required/>
                                <input type="password" name="password2"  placeholder="repeate new password" size="35"
                                       required/>
                            ...
                            <div class="form_field_wrap">
                                <br><br><br>
                                <input type="submit" name="submit"  value="reset password" size="35" >
                                <br>
                                <br><br><br>
                            </div>

...
if(!empty($_REQUEST['phone_no'])) {
    ...
    if(!empty($_REQUEST['address'])) {
        $phone_no = $_REQUEST['address'];
        $phone_no=mysqli_real_escape_string($conn,$address);
    }
    ...
    if($count == 1){
        ...
        $message = "<a href='http://localhost/hotel/registeration_verified.php?vkey=$vkey'>confirm sign up</a>";
        $headers = "From:zizoo4949@yahoo.com" . "\r\n";
        $headers .= "MIME-Version: 1.0" . "\r\n";
        $headers .= "Content-Type: text/html; charset=UTF-8" . "\r\n";
        if (mail($to, $subject, $message, $headers)) {
            $q = "insert into customer(name,age,gender,email,phone_no,username,password,vkey,verified) VALUES 
        ('$name','$age','$gender','$email','$phone_no','$username','$password','$vkey','0') ";
            mysqli_query($conn, $q);
...
<head>
    ...
    <title>Sign up &#8211;Habibi Hotel</title>
                    ...
                    <div class="cmsmasters_row_margin">
                        <div id="cmsmasters_column_11b707bf2a" class="cmsmasters_column one_first">
                            <div class="cmsmasters_column_inner"><div id="cmsmasters_heading_c26a058b3e" class="cmsmasters_heading_wrap cmsmasters_heading_align_center">
                                    ...
                                    <h2 class="cmsmasters_heading">sign up</h2>
                                </div>
                            </div></div>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form_info cmsmasters_input one_half">
                                ...
                                <div class="form_field_wrap">
                                    <input type="text" name="name"  placeholder="name" size="35"
                                           required/>
                                    <br><br><br>
                                </div>
                            </div>
                            <div class="form_info cmsmasters_input one_half">
                                <label for="cmsmasters_email_2">Age <span class="color_2"></span></label>

                                <div class="form_field_wrap">
                                    <input type="text" name="age"  placeholder="age" size="35"
                                           />
                                    <br><br><br>
                                </div>
                            </div>
                            <div class="form_info cmsmasters_input one_half">
                                <label for="cmsmasters_subject">Gender <span class="color_2"></span></label>

                                <div class="form_field_wrap">
                                    <input type="radio" name="gender" class="" value="" size="35" >Male</input>
                                    <input type="radio" name="gender" class="" value="" size="35" >Female</input>
                            ...
                            <div class="form_info cmsmasters_input one_half">
                                <label for="cmsmasters_name_2">Phone No <span class="color_2"></span></label>

                                <div class="form_field_wrap">
                                    <input type="text" name="phone_no"  placeholder="phone_no"  size="35"
                                           />
                                    <br><br><br>
                                </div>
                            </div>
                            ...
                            <div class="form_info cmsmasters_input one_half">
                                <label for="cmsmasters_name_2">Address <span class="color_2"></span></label>
                            ...
                            <div class="form_info cmsmasters_input one_half">
                                <label for="cmsmasters_email_2">Username<span class="color_2">*</span></label>

                                <div class="form_field_wrap">
                                    <input  name="username"  placeholder="username" size="35"
                                           reqired/>
                                    <br><br><br>
                                </div>
                            </div>
                            <div class="form_info cmsmasters_input one_half">
                                <label for="cmsmasters_email_2">Password<span class="color_2">*</span></label>
                            ...
                            <div class="form_info cmsmasters_input one_half">
                                <label for="cmsmasters_email_2">Repeate Password <span class="color_2">*</span></label>

                                <div class="form_field_wrap">
                                    <input type="password" name="password2" placeholder="password" size="35"
                                           reqired/>
                                    <br><br><br>
                                </div>
                            </div>
                                ...
                                <div class="form_field_wrap">
                                    <br><br><br>
                                    <input type="submit" name="submit"  value="sign up" size="35" >
                                    <br>
                                    <br><br>
                                </div>
                            </div>
